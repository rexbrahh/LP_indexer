...
- Service overview: [Service: api](../../../../services/api)
- Architecture: [Pipeline architecture](../../../../architecture/pipeline) and [Storage (ClickHouse + Parquet)](../../../../architecture/storage)
- Package walkthrough: [`api/`](../../api) and response types in [`api/http/types/types.go`](./types/)
