...
- Ops: [Ops: ClickHouse operations](../../../../../ops/clickhouse) and ClickHouse schema in [`ops/clickhouse/all.sql`](../../../ops/clickhouse/all)
- Package walkthrough: [`sinks/`](../../../sinks) and [`ops/`](../../../ops)
