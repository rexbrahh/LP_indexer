...
- Service overview: [Service: ingestor](../../../../../services/ingestor)
- Architecture: [Pipeline architecture](../../../../../architecture/pipeline) and [NATS / JetStream design](../../../../../architecture/nats)
- Schema: [`proto/dex/sol/v1/core.proto`](../../../proto/dex/sol/v1/core)
- Package walkthrough: [`ingestor/`](../../../ingestor) and shared publisher config in [`sinks/nats/config.go`](../../../sinks/nats/config)
