...
- Architecture: [NATS / JetStream design](../../../../architecture/nats) and [Canonical event model](../../../../architecture/events)
- Ops: [Ops: NATS / JetStream operations](../../../../ops/nats-jetstream)
- Publisher implementation: [`sinks/nats/publisher.go`](../../sinks/nats/publisher)
