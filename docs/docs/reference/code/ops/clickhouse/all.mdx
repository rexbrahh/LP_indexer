...
- Architecture: [Storage (ClickHouse + Parquet)](../../../../architecture/storage)
- Ops: [Ops: ClickHouse operations](../../../../ops/clickhouse) and schema apply script [`scripts/apply_clickhouse_schema.sh`](../../scripts/apply_clickhouse_schema)
- Writer implementation: [`sinks/clickhouse/writer.go`](../../sinks/clickhouse/writer)
