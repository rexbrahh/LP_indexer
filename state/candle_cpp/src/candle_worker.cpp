...
Shard::get_or_create_windows(const std::string &pair_id) {
  ...
  new_windows.push_back(
      std::make_shared<CandleWindow>(WindowSize::SEC_1, pair_id));
  new_windows.push_back(
      std::make_shared<CandleWindow>(WindowSize::MIN_1, pair_id));
  new_windows.push_back(
      std::make_shared<CandleWindow>(WindowSize::MIN_5, pair_id));
  new_windows.push_back(
      std::make_shared<CandleWindow>(WindowSize::MIN_15, pair_id));
  new_windows.push_back(
      std::make_shared<CandleWindow>(WindowSize::HOUR_1, pair_id));
  new_windows.push_back(
      std::make_shared<CandleWindow>(WindowSize::HOUR_4, pair_id));
  new_windows.push_back(
      std::make_shared<CandleWindow>(WindowSize::DAY_1, pair_id));
...
CandleWorker::~CandleWorker() { stop(); }
